    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-header">
                <b>Form Edit Data Produk</b>
            </div>
            <div class="card-body">
                <form action="/product/<?= $produk['id_produk']; ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= ($validation->hasError('kode_produk')) ? 'is-invalid' : ''; ?>" id="kode_produk" name="kode_produk" value="<?= (old('kode_produk')) ? old('kode_produk') : $produk['kode_produk']; ?>">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <textarea id="mytextarea" name="deskripsi_produk"><?= (old('deskripsi_produk')) ? old('deskripsi_produk') : $produk['deskripsi_produk']; ?></textarea>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control <?= ($validation->hasError('id_jenis')) ? 'is-invalid' : ''; ?>" id="id_jenis" name="id_jenis">
                                ...
                                <?php foreach ($jenis as $j) : ?>
                                    <option value="<?= $j['id_jenis']; ?>" <?= ($produk['id_jenis'] == $j['id_jenis']) ? 'selected' : old('id_jenis'); ?>><?= $j['nama_jenis'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="invalid-feedback">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <img src="/img/produk/<?= $produk['gambar_produk']; ?>" id="frame" class="img-fluid" width="250px">
                        </div>
                    </div>
                    <div class="row mb-3">
